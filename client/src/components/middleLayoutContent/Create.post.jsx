...
const CreatePost = () => {
  return (
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16 bg-white dark:bg-gray-900 rounded-lg p-6 mb-4">
      <div className="__feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box flex gap-3 mb-4">
          {/* Profile Image */}
          <div className="_feed_inner_text_area_box_image flex-shrink-0">
            <img
              src="/images/img1.png"
              alt="Image"
              className="_txt_img w-12 h-12 rounded-full object-cover"
            />
          </div>

          {/* Textarea with floating SVG */}
          <div className="form-floating _feed_inner_text_area_box_form flex-1 relative">
            <textarea
              id="floatingTextarea"
              placeholder=""
              className="_textarea peer focus:placeholder-transparent"
            />

            <label
              htmlFor="floatingTextarea"
              className="_feed_textarea_label absolute left-3 top-3 text-gray-400 text-sm pointer-events-none flex items-center gap-1 transition-opacity duration-200 peer-placeholder-shown:opacity-100 peer-focus:opacity-0"
            >
              Write something ...
              <svg
      ...
      {/* Desktop Buttons */}
      <div className="_feed_inner_text_area_bottom hidden md:flex items-center justify-between">
        <div className="_feed_inner_text_area_item flex flex-wrap gap-2">
          <div className="_feed_inner_text_area_bottom_photo _feed_common">
            <button
              type="button"
              className="_feed_inner_text_area_bottom_photo_link flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 text-sm"
            >
        ...
        <div className="_feed_inner_text_area_btn">
          <button
            type="button"
            className="_feed_inner_text_area_btn_link flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 text-sm font-medium"
          >
            <svg
              className="_mar_img"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="lg:hidden">
        <div className="_feed_inner_text_mobile">
          <div className="_feed_inner_text_area_item flex gap-2">
            <button
              type="button"
              className="_feed_inner_text_area_bottom_photo_link p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
